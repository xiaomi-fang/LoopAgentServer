        ...
        <div className="bg-white border-b px-8 py-4 flex items-center justify-between shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-xl font-bold text-gray-800">
              <i className={`fas ${isEdit ? 'fa-edit' : 'fa-plus-circle'} mr-2 text-blue-500`}></i>
              {isEdit ? '编辑项目' : '新建项目'}
            </h2>
          </div>
          <div className="flex items-center gap-3">
            ...
            <button onClick={handleSave} disabled={saving}
              className="px-6 py-2 text-sm text-white bg-blue-600 hover:bg-blue-700 rounded transition disabled:opacity-50 flex items-center gap-2">
